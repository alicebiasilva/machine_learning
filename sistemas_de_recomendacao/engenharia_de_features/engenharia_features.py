...
import sys
sys.path.append(r"C:\Users\alice\OneDrive\Área de Trabalho\machine_learning\sistemas_de_recomendacao")
from engenharia_de_features.prompts import SYSTEM_PROMPT, AGENT_PROMPT
from engenharia_de_features.schemas import AzureAIMessage
